...
import com.inclusive.finance.jh.databinding.FragmentCompanyPsersonnelBinding
 ...
 *
 * */
class CompanyPersonnelFragment : MyBaseFragment(), PresenterClick {
    lateinit var adapter: ItemBaseTypeAdapter<BaseTypeBean>
    lateinit var viewModel: ApplyModel
    lateinit var viewBind: FragmentCompanyPsersonnelBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?,
    ): View {
        viewBind = FragmentCompanyPsersonnelBinding.inflate(inflater, container, false).apply {
            presenterClick = this@CompanyPersonnelFragment
    ...
    override fun initView() {
        adapter = ItemBaseTypeAdapter(this@CompanyPersonnelFragment)
...
//                adapter.setNewInstance(list)
        when (viewModel.businessType) {
            ...
            ApplyModel.BUSINESS_TYPE_JNJ_JC_OFF_SITE_PERSONAL, -> {
                getUrl=Urls.get_jnj_cj_personal_qyygs
                businessType="03"
            }
        }
