 ...
 * 损益简表
 * */
class SYJBFragment2 : MyBaseFragment(), PresenterClick {
    ...
    override fun onCreateView(
        ...
        viewBind = FragmentSyjbBinding.inflate(inflater, container, false).apply {
            presenterClick = this@SYJBFragment2
    ...
    override fun initView() {
        adapter = ItemBaseTypeAdapter(this@SYJBFragment2)
        viewBind.mRecyclerView.layoutManager = GridLayoutManager(act, 6)
    ...
    override fun initData() {
        DataCtrlClass.KHGLNet.getBaseTypePoPList(context, url = Urls.getSYJB, keyId = viewModel.keyId) {
            if (it != null) {
