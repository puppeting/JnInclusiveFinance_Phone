...
import com.inclusive.finance.jh.databinding.FragmentCompanyElectricBinding
 ...
 *
 * */
class CompanyElectricFragment : MyBaseFragment(), PresenterClick {
    lateinit var adapter: ItemBaseTypeAdapter<BaseTypeBean>
    lateinit var viewModel: ApplyModel
    lateinit var viewBind: FragmentCompanyElectricBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?,
    ): View {
        viewBind = FragmentCompanyElectricBinding.inflate(inflater, container, false).apply {
            presenterClick = this@CompanyElectricFragment
    ...
    override fun initView() {
        adapter = ItemBaseTypeAdapter(this@CompanyElectricFragment)
...
//                adapter.setNewInstance(list)
        when (viewModel.businessType) {
            ...
            -> {
                getUrl=Urls.get_jnj_cj_personal_qyyd
                businessType="03"
            }
        }
