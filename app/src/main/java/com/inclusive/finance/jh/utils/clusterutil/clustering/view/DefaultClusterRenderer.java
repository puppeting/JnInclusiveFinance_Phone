...
import com.inclusive.finance.jh.utils.clusterutil.MarkerManager;
...
import com.inclusive.finance.jh.utils.clusterutil.projection.Point;
import com.inclusive.finance.jh.utils.clusterutil.projection.SphericalMercatorProjection;
import com.inclusive.finance.jh.utils.clusterutil.ui.IconGenerator;
...
import static com.inclusive.finance.jh.utils.clusterutil.MarkerManager.MAX_DISTANCE_AT_ZOOM;

/**
 * The default view for a ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.inclusive.finance.jh.utils.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.inclusive.finance.jh.utils.clusterutil.ui.SquareTextView makeSquareTextView(
            Context context) {
        com.inclusive.finance.jh.utils.clusterutil.ui.SquareTextView squareTextView =
                new com.inclusive.finance.jh.utils.clusterutil.ui.SquareTextView(context);
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            for (Cluster<T> c : clusters) {
                if (SZWUtils.INSTANCE.compareLatLng(mMap,c.getPosition())){
