...
internal class SnackbarManager private constructor() {
    ...
    fun show(duration: Int, callback: Callback) {
        synchronized(mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar, TSnackbar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private fun isCurrentSnackbar(callback: Callback): Boolean {
        return mCurrentSnackbar != null && mCurrentSnackbar?.isSnackbar(callback)==true
    }

    private fun isNextSnackbar(callback: Callback): Boolean {
        return mNextSnackbar != null && mNextSnackbar?.isSnackbar(callback)==true
    }
    ...
    companion object {
        ...
        fun getInstance(): SnackbarManager{
            ...
            return sSnackbarManager as SnackbarManager
        }
    }
