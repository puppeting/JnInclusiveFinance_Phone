package com.inclusive.finance.jh.widget.gesture;
...
public class GestureLockLayout extends RelativeLayout {
    ...
    //LockView数组
    private final ArrayList<ILockView> mILockViews = new ArrayList<>(1);
    ...
    //保存选中的LockView id
    private final ArrayList<Integer> mChooseList = new ArrayList<>(1);
    //答案list
    private final ArrayList<Integer> mAnswerList = new ArrayList<>(1);
...
//                    return new QQLockView(context);
        ...
        mPaint.setStrokeWidth(SizeUtils.dp2px(mStrokeWidth));
    ...
    private void handleVerifyMode() {
        ...
        toggleLockViewMatchedState(isAnswerRight);
    }
    ...
    public void setPathWidth(float dp) {
        mPaint.setStrokeWidth(SizeUtils.dp2px(dp));
    }
