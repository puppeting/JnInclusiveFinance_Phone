 ...
 * 影像资料
 * */
class AddYSXFragment : MyBaseFragment(), PresenterClick {
    ...
    override fun onCreateView(
        ...
        viewBind = FragmentPicListBinding.inflate(inflater, container, false).apply {
            presenterClick = this@AddYSXFragment
    ...
    override fun initView() {
        adapter = ItemBaseTypeAdapter(this@AddYSXFragment)
    ...
    override fun initData() {
        ...
        getUrl = Urls.get_sunCredit
        saveUrl = Urls.save_sunCredit
