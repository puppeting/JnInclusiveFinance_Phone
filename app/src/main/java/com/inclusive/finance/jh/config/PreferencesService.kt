...
object PreferencesService {
     ...
     * @param accountValue 密码
     */
    fun saveHJBH(context: Context, accountKey: String) {

        val preferences = context.getSharedPreferences(DATA_CONTEXT, Context.MODE_PRIVATE)
        val editor = preferences.edit()
        editor.putString("accountjibh", accountKey)
         editor.apply()
    }
    /**
     * @return
     */
    fun getHJBH(context: Context): String? {
        val accountValue: String?
        val preferences = context.getSharedPreferences(DATA_CONTEXT, Context.MODE_PRIVATE)
        accountValue = preferences.getString("accountjibh", null)
        return accountValue
    }
    /**
     * @return  获取密码
    ...
    /**
     * @param accountKey 我行业务-个人共同借款人
     */
    fun saveJson(context: Context, checkType: String ){

        val preferences = context.getSharedPreferences(DATA_CONTEXT, Context.MODE_PRIVATE)
        val editor = preferences.edit()
        editor.putString("bankJson", checkType)
        editor.apply()
    }
    /**
     * @param accountKey 我行业务-个人、共同借款人
     */
    fun getJson(context: Context ): String? {

        val preferences = context.getSharedPreferences(DATA_CONTEXT, Context.MODE_PRIVATE)

        return preferences.getString("bankJson", "")
    }
}
