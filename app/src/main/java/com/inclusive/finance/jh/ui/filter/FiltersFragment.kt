...
import com.inclusive.finance.jh.databinding.FragmentFiltersBinding
 ...
 */
@AndroidEntryPoint
class FiltersFragment(var fragment:Fragment,var searchListener:(selectList:MutableList<FilterChip>, searchStr:String,  resultCountCallBack: (count: String)->Unit)->Unit) : BottomSheetDialogFragment() {
    companion object {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel = ViewModelProvider(fragment).get(SearchViewModel::class.java)
